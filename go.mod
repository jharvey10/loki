...
// Use Grafana fork of Prometheus for Docker API compatibility
replace github.com/prometheus/prometheus => github.com/grafana/prometheus v1.8.2-0.20240923102244-45588978c949
